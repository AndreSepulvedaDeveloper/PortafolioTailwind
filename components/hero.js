      ...
      <Container className="flex flex-wrap ">
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            <h1 className=" py-3 text-3xl  font-bold leading-snug tracking-tight text-gray-800 lg:text-3xl lg:leading-tight xl:text-5xl xl:leading-tight dark:text-white">
              Desarrollo Web Front-end
            </h1>
            <p className=" py-2 text-2xl tracking-tight text-gray-800 lg:text-3xl lg:leading-tight xl:text-2xl xl:leading-tight dark:text-white">
              "Transformo ideas en experiencias web cautivadoras. Tu presencia
              en línea merece destacar y yo estoy aquí para hacerlo posible.
              Descubre la magia del diseño y el código conmigo. Juntos, creamos
              un impacto digital inolvidable."
            </p>

            <div className=" py-5 flex flex-col items-start space-y-3 sm:space-x-4 sm:space-y-0 sm:items-center sm:flex-row">
              <a
                href="https://github.com/AndreSepulvedaDeveloper"
                target="_blank"
                rel="noopener"
                className="flex font-stock  space-x-3 text-gray-500 dark:text-gray-400"
              >
                <svg
                  role="img"
                  width="24"
      ...
      <Container>
        <div className="flex flex-col justify-center">
          <div className="text-xl text-center text-gray-700 dark:text-white">
            Estas son las <span className="text-indigo-600">Tecnologias</span>{" "}
            utilizadas
          </div>
